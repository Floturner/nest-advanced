...
const FAILURE_THRESHOLD = 3; // number of failures operations above which we open the circuit
const OPEN_TO_HALF_OPEN_WAIT_TIME = 1000 * 60; // 1 minute in milliseconds
